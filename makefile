...
'_QSPShowWindow', \
'_QSPGetVarValuesCountW', \
'_QSPGetVarValuesW', \
'_QSPGetMaxVarsCount', \
'_QSPGetVarNameByIndexW', \
'_QSPExecStringW', \
'_QSPExecCounter', \
'_QSPExecUserInput', \
'_QSPExecLocationCodeW', \
'_QSPGetLastErrorDataW', \
'_QSPGetErrorDescW', \
'_QSPLoadGameWorldW', \
'_QSPLoadGameWorldFromDataW', \
'_QSPSaveGameW', \
'_QSPSaveGameAsDataW', \
'_QSPOpenSavedGameW', \
'_QSPOpenSavedGameFromDataW', \
'_QSPRestartGame', \
'_QSPSelectMenuItem', \
'_QSPSetCallBack', \
'_QSPInit', \
